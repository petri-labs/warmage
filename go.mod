...
replace (
	github.com/Gravity-Bridge/Gravity-Bridge/module => github.com/warmage-zone/gravity/module v0.0.0-20220726103435-1f23555a12c8
	github.com/cosmos/cosmos-sdk => github.com/warmage-zone/cosmos-sdk v0.45.4-warmage.6
