...
import (
	...
	"github.com/petri-labs/warmage/testutil/network"
)
...
Example:
	maged testnet init-files --validators 4 --output-dir ./.testnet --starting-ip-address 192.168.10.2
	`,
	...
	cmd.Flags().String(flagNodeDaemonHome, "maged", "Home directory of the node's daemon configuration")
...
Example:
	maged testnet --validators 4 --output-dir ./.testnet
	`,
		RunE: func(cmd *cobra.Command, _ []string) error {
			args := startArgs{}
			args.outputDir, _ = cmd.Flags().GetString(flagOutputDir)
